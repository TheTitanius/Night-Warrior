    ...
    class TestLevel: Scene {
        ...
        public static void CreateTestLevel() {
            ...
            teastLevel.enemies = new List<Enemy> {
                new Enemy(1000, 100, @"D:\Projects\C#\CourseWork\Night Warrior\Night Warrior\res\test_enemy.png", new Size(80, 100), new Rectangle(0, 0, 80, 100), 4, ForceGravity),
            };
            character = new Character(0, 100, @"D:\Projects\C#\CourseWork\Night Warrior\Night Warrior\res\test_character.png", new Size(60, 100), new Rectangle(0, 0, 60, 100), 10, ForceGravity, G);
        }
